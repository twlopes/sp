...
DATABASES = {
    'default': {
        ...
        'NAME': 'spdata',                      # Or path to database file if using sqlite3.
...
# Code required to operate Django-Guardian
...
# Code required for authentication information to be passed aroound with RequestContext
